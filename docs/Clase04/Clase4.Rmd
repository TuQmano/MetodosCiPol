...
* Funciones que permiten manipular caracteres individuales dentro de las cadenas en vectores de caracteres (_vg_ : **`str_sub(string = DF, start = 1, end = 4)`**.

--

* Herramientas para agregar, eliminar y manipular espacios en blanco (_vg_ : **`str_pad(string = DF , width = 2 , side = "left" , pad = 0)`**.
...
**`str_detect(string = DF, pattern = ":digits:")`**
