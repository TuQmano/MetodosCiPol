...
[`r icon::fa("link")` {readr} Cheatsheet](https://github.com/rstudio/cheatsheets/raw/master/translations/spanish/data-import-Spanish_translation-2019.pdf)
...
> Lupu, Noam and Susan C. Stokes. 2009. "The Social Bases of Political Parties in Argentina, 1912-2003." Latin American Research Review 44 (1): 58-87. Fuente: [www.noamlupu.com/data.html](www.noamlupu.com/data.html)
...
`r icon::fa("link")` [https://docs.google.com/spreadsheets/](https://docs.google.com/spreadsheets/d/1J84PviVxVMsCDzupOcD0_s_yc92vm4sCB6uoJQtl2mU/)
...
background-image: url(https://github.com/sfirke/janitor/raw/master/man/figures/logo_small.png)
background-position: 95% 5%
background-size: 10%
...
**-> _live coding_ con datos de `{polAr}`**
...
> _Cuántos puntos porcentuales de diferencia hubo entre el primero y segundo en la elección a presidente 2003 en _su_ provincia?_ 
